...
import UsernameLoanUsernameLoanLoan from './username/loan/username.loan.loan'
...
export default { 
  ...
  UsernameLoanUsernameLoanLoan: load(UsernameLoanUsernameLoanLoan, 'username.loan.loan'),
