...
func (k msgServer) RepayLoan(goCtx context.Context, msg *types.MsgRepayLoan) (*types.MsgRepayLoanResponse, error) {
	...
	if msg.Creator != loan.Borrower {
		return nil, sdkerrors.Wrap(sdkerrors.ErrUnauthorized,"Cannnot repay: not the borrower")
	}
	...
	if err != nil {
		return nil, sdkerrors.Wrap(types.ErrWrongLoanState,"Cannnot send coins")
	}
